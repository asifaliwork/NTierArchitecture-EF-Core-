...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20240623080810_ManyToManyRelationBetweenAuthor_Book")]
    partial class ManyToManyRelationBetweenAuthor_Book
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthorBook", b =>
                {
                    b.HasOne("ModelsLayer.Models.Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorsAuthor_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ModelsLayer.Models.Book", null)
                        .WithMany()
